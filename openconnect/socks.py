...
# CONST (Fixed Buffer Size for better throughput)
BUFLEN = 65536
TIMEOUT = 300  # Pinataas ang timeout para hindi agad maputol kapag idle
...
class Server(threading.Thread):
    ...
    def run(self):
        ...
        # Idinagdag ang TCP Keepalive para maiwasan ang sudden disconnect ng ISP
        try:
